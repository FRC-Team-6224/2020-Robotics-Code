...
public class VisionSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // double vOffset = NetworkTableInstance.getDefault().getTable("limelight").getEntry("ty").getDouble(0);
    
    // System.out.println("Has Target " + hasTarget + " hOffset " + hOffset + " vOffset " + vOffset);
